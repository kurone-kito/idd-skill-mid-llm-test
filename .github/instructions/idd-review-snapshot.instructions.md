...
The target repository has no IDD-managed advisory reviewer. E1 still
fetches human review threads, review bodies, regular comments, and CI
activity, but it does not create Copilot PATH B items or require a
Copilot-current-head signal. A future human or explicitly configured
review bot remains subject to the ordinary review-universe rules.
