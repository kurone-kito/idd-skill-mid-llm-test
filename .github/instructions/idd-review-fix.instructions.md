...
This repository's `reviewPolicy` is `no-advisory`. The imported E14
Copilot request and wait procedure below is not executable here. After
E13 has completed its human-review dispositions, go directly to E15;
never request or wait for Copilot, post an advisory-wait marker, or treat
an advisory absence as a blocker. CI, branch protection, unresolved
conversations, and claim freshness remain mandatory.
