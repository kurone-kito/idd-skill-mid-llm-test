...
Do not manufacture PATH B advisory items for Copilot in this repository:
no advisory reviewer is requested or waited on. Classify actionable
human or required-review feedback as PATH A and retain the normal
verify-before-accept, disposition, thread-resolution, and CI rules.
