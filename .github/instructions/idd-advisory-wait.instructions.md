...
> **Local profile override — no-advisory:** This repository does not use
> an IDD-managed advisory reviewer. This file is retained for import
> completeness and reference only. Do not request, wait for, recover, or
> disposition a Copilot advisory review in E14, F2, or F3.
