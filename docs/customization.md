...
| ------------------------------------------------------------------- | -------------------------------- |
| `idd-skill` in repo-name contexts                                   | `idd-skill-mid-llm-test`                  |
| `idd-skill` in marker-prefix contexts (e.g. `idd-skill-roadmap-id`) | `mid-llm-test`      |
| **fix-validate** command string                                     | `true`      |
| **pre-push-validate** command string                                | `true` |
| **post-fix-validate** command string                                | `true` |
...
- `audit-docs.mjs` enforces synchronization rules defined in
  `sync-manifest.json`
- Template copies use placeholders like `idd-skill-mid-llm-test` to support
